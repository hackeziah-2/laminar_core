...
from app.constants.audit import (
    AUTHORIZATION_SCOPE_OTHERS_MODULE_NAME,
    AUTHORIZATION_SCOPE_OTHERS_TABLE_NAME,
)
...
async def api_create(
    ...
    return await create_authorization_scope_others(
        ...
        audit_module_name=AUTHORIZATION_SCOPE_OTHERS_MODULE_NAME,
        audit_table_name=AUTHORIZATION_SCOPE_OTHERS_TABLE_NAME,
...
async def api_delete(
    ...
    deleted = await soft_delete_authorization_scope_others(
        session,
        scope_id,
        audit_module_name=AUTHORIZATION_SCOPE_OTHERS_MODULE_NAME,
        audit_table_name=AUTHORIZATION_SCOPE_OTHERS_TABLE_NAME,
