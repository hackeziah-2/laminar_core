...
from app.constants.audit import (
    AUTHORIZATION_SCOPE_CESSNA_MODULE_NAME,
    AUTHORIZATION_SCOPE_CESSNA_TABLE_NAME,
)
...
async def api_list_paged(
    ...
    return paged_payload(
        [AuthorizationScopeCessnaRead.from_orm(i) for i in items],
        total=total,
...
async def api_create(
    ...
    return await create_authorization_scope_cessna(
        session,
        payload,
        audit_account_id=current_account.id,
        audit_module_name=AUTHORIZATION_SCOPE_CESSNA_MODULE_NAME,
        audit_table_name=AUTHORIZATION_SCOPE_CESSNA_TABLE_NAME,
...
async def api_update(
    ...
    updated = await update_authorization_scope_cessna(
        session,
        scope_id,
        payload,
        audit_account_id=current_account.id,
...
async def api_delete(
    ...
    deleted = await soft_delete_authorization_scope_cessna(
        session,
        scope_id,
        audit_module_name=AUTHORIZATION_SCOPE_CESSNA_MODULE_NAME,
        audit_table_name=AUTHORIZATION_SCOPE_CESSNA_TABLE_NAME,
