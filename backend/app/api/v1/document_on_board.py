...
@router.post(
    ...
    description="Create a new DocumentOnBoard entry. Required fields: aircraft_id, document_name, issue_date. "
                "Optional fields: description, expiry_date, warning_days, status, file_path. "
                "Send JSON data as 'json_data' form field and optional file as 'upload_file'.",
