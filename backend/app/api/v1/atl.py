...
async def atl_paged(
    ...
    """Get paginated ATL list for aircraft. Path: aircraft_id. Search: sequence_no. Filter: nature_of_flight. Sort: sequence_no asc/desc. Pagination: 50, 100, 500. All floats and auto_comp_* formatted to 2 decimal places."""
